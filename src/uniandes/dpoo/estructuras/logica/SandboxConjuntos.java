...
public class SandboxConjuntos
{
    ...
    {
    	Iterator<String> it= this.arbolCadenas.descendingIterator();
    	List<String> lista = new ArrayList<String>();
    ...
    /**
     * Retorna una colección con las cadenas que hacen parte del conjunto de cadenas y 
     * son mayores o iguales a la cadena que se recibe por parámetro
     * @param cadena
    ...
    {
    	Collection<String> siguientes = new TreeSet<String>(); 
    	
        siguientes = this.arbolCadenas.tailSet(cadena); 
    ...
    {
    	this.arbolCadenas.removeIf(cad -> (cad.equalsIgnoreCase(cadena)));
    }
    ...
    {
    	Iterator<Object> it1 = objetos.iterator();
    	this.arbolCadenas.clear();
    	
    	while (it1.hasNext())
    	{
    		this.arbolCadenas.add(it1.next().toString());
    	}
    }
    ...
    {
    	NavigableSet<String> nuevoSet = new TreeSet<String>();
    	
    	Iterator<String> it1 = this.arbolCadenas.iterator();
    	
    	while (it1.hasNext())
    	{
    		nuevoSet.add(it1.next().toUpperCase());
    	}
    ...
    public TreeSet<String> invertirCadenas( )
    {
    	...
    	TreeSet<String> nuevoSet =(TreeSet<String>)this.arbolCadenas.descendingSet();
    ...
    {
    	List<String> elemLista = Arrays.asList(otroArreglo);
    	boolean contiene = this.arbolCadenas.containsAll(elemLista);
        return contiene;
    }
